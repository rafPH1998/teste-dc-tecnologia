          ...
          <form method="POST" action="{{ route('authenticate') }}" class="p-10 bg-white rounded flex justify-center items-center flex-col shadow-md">
            ...
            <div class="flex flex-col gap-4 px-0 py-4">
              ...
              <div>
                  ...
                  <input type="email" id="email" name="email" placeholder="Digite seu e-mail" value="{{ old('email') }}" class="py-2 pl-10 w-full border focus:outline-none">
                  @if ($errors->has('email'))
              ...
              <div>
                  ...
                  <input type="password" id="password" name="password" placeholder="Digite seu senha" value="{{ old('password') }}" class="py-2 pl-10 w-full border focus:outline-none">
